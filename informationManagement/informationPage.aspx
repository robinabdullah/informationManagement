        ...
        <tr>
          ...
          <tr>
             ...
             <td>
                 ...
                 <asp:Button ID="delete" runat="server" Text="Delete" Visible="false" OnClientClick="return confirm('Are you sure?')" OnClick="delete_Click"/>
                 ...
                 | <a href="searchDetails.aspx">Search Details</a> 
